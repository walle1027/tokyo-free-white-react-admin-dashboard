...
import { Box, IconButton, Tooltip, Avatar, Accordion, AccordionSummary, AccordionDetails, useTheme, Drawer, Divider, Typography, List, ListItem, ListItemText, ListItemIcon } from '@material-ui/core'
...
function TopBarContent() {
    ...
    const handleChange = (section: string) => (event: SyntheticEvent, isExpanded: boolean) => {
        ...
        <>
            <RootWrapper>
                <Box sx={{ display: { sm: 'flex' } }} alignItems="center">
                    <Avatar variant="rounded" sx={{ width: 50, height: 50 }} alt="Zain Baptista" src="/static/images/avatars/2.jpg" />
            ...
            <Drawer variant="temporary" anchor={theme.direction === 'rtl' ? 'left' : 'right'} open={mobileOpen} onClose={handleDrawerToggle} elevation={9}>
