import { Card, Avatar, Tooltip, IconButton, Box, Button, Hidden, TextField, Divider } from '@material-ui/core'
...
function BottomBarContent() {
    ...
    return (
        <Card sx={{ display: 'flex', alignItems: 'center', p: 2 }}>
            ...
            <Box sx={{ flex: 1, mr: 2 }}>
                <TextField hiddenLabel fullWidth placeholder="Write here your message..." />
            </Box>
