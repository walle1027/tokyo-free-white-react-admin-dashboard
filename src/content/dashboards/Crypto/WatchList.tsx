...
import { Button, Box, ToggleButton, ToggleButtonGroup, Grid, Card, Typography } from '@material-ui/core'
...
function WatchList() {
    ...
    const handleViewOrientation = (event: MouseEvent<HTMLElement>, newValue: string | null) => {
        setTab(newValue)
    }
                ...
                {!tabs && (
                    <Grid item xs={12}>
                        <Card sx={{ textAlign: 'center', p: 3 }}>
                            ...
                            <Typography align="center" variant="h2" fontWeight="normal" color="text.secondary" sx={{ mt: 3 }} gutterBottom>
