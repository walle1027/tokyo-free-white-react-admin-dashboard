...
import { Box, Typography, Hidden, Container, Button, Grid } from '@material-ui/core'
                    ...
                    <Grid xs={12} md={6} alignItems="center" display="flex" justifyContent="center" item>
                        <Container maxWidth="sm">
                            <Box textAlign="center">
                                ...
                                <LoadingButton onClick={handleClick} loading={pending} variant="outlined" color="primary" startIcon={<RefreshTwoToneIcon />}>
                                    Refresh view
                                </LoadingButton>
                            ...
                            <Container maxWidth="sm">
                                <Box textAlign="center">
                                    ...
                                    <TypographySecondary variant="h4" fontWeight="normal" sx={{ mb: 4 }}>
                                        High performance React template built with lots of powerful Material-UI components across multiple product niches for fast &amp; perfect apps development
                                        processes.
                                    </TypographySecondary>
