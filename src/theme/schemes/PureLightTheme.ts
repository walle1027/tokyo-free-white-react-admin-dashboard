...
export const PureLightTheme = createTheme({
    ...
    typography: {
        fontFamily: ['"Roboto"', '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"'].join(','),
        fontSize: 14,
        htmlFontSize: 15,
        h1: {
            fontWeight: 700,
